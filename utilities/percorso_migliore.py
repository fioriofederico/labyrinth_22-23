...
"""
Data una lista di w e c nella variabile main restituisce il percorso migliore.
Per il nostro caso si dovrebbe sostituire il nostro output di w e c e ristampare una nuova immagine in cui le p formano la riga del percorso ottimo.
"""
